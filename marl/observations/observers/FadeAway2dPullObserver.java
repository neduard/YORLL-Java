...
public class FadeAway2dPullObserver extends VisualPullObserver
{
    ...
    public FadeAway2dPullObserver(Observable observable) {
        super(observable);
        init(DEFAULT_MAXSIZE);
    }
    public FadeAway2dPullObserver(Observable observable, int maxSize) {
        super(observable, maxSize);
        init(maxSize);
    }
    public FadeAway2dPullObserver(Observable observable, int maxSize, int hertz) {
        super(observable, maxSize, hertz);
        init(maxSize);
    }
    ...
    @Override
    public void pull(Observation o) {
