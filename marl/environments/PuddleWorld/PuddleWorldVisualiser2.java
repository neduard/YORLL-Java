...
public class PuddleWorldVisualiser2 extends TrailAway2dPushObserver
{
     ...
     * 
     */
    public PuddleWorldVisualiser2(int episodeLength)
    {
        super(episodeLength);
     ...
     * @param maxSize
     */
    public PuddleWorldVisualiser2(int episodeLength, int maxSize)
    {
