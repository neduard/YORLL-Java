 ...
 *
 */
public class MultiAgentMazeExperiment {
			...
			throws IOException
	{
	    ...
	    if( args.length > 1 )
	        ...
	        configurationPath = "experiments/example/configMultiAgentMaze.ini";
	    ...
	    MazeEnvironment<MultiAgentMazeAgent> env    = new MazeEnvironment<>(cfg);
	    MultiAgentMazeAgent[]     agents = new MultiAgentMazeAgent[nAgents];
	    for( int i=0; i<nAgents; i++ )
	    	agents[i] = new MultiAgentMazeAgent(cfg);
