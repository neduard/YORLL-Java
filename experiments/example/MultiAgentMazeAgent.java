...
public class MultiAgentMazeAgent
	extends Agent<MazeEnvironment<MultiAgentMazeAgent>>
{
	private Config        cfg_;
	private int           action_;
	...
	public MultiAgentMazeAgent(Config cfg)
	{
		cfg_ = cfg;
	}
	...
	@Override
	public void add(MazeEnvironment<MultiAgentMazeAgent> env) {
	    super.add(env);
