...
public class AcrobotExperiment
{
		...
		throws IOException
	{
	    ...
	    if( args.length > 1 )
	        ...
	        configurationPath = "experiments/example/configAcrobot.ini";
	    ...
	    AcrobotEnvironment<AcrobotAgentTC> env   = new AcrobotEnvironment<>();
	    AcrobotAgentTC                     agent = new AcrobotAgentTC(cfg);
